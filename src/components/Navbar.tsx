...
//                   <SignInButton>
//                     <button className="px-4 py-2 text-sm font-medium text-purple-200 hover:text-white border border-purple-500/50 rounded-lg hover:border-purple-400 hover:bg-purple-800/30 transition-all duration-200 backdrop-blur-sm">
//                       Sign In
//                     </button>
//                   </SignInButton>
//                   <SignUpButton>
//                     <button className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 rounded-lg shadow-lg hover:shadow-purple-500/25 transition-all duration-200 transform hover:scale-105">
//                       Sign Up
//                     </button>
//                   </SignUpButton>
//                 </div>
...
//                     // appearance={{
//                     //   elements: {
//                     //     avatarBox: "w-8 h-8 ring-2 ring-purple-400/50 hover:ring-purple-300 transition-all duration-200",
...
//               <a
//                 href="#home"
//                 className="flex items-center space-x-3 text-purple-200 hover:text-white p-3 rounded-lg hover:bg-slate-800/50 transition-colors"
//               >
